...
- 已完成前端构建 code split：Workbench 对 `LiveKitPocPanel` 使用 lazy import，RTSP/HLS 预览对 `hls.js` 使用按需 import，Vite 将 `livekit`、`hls`、`react-vendor`、`icons` 拆为独立 chunk，桌面端主工作台 chunk 约 45.9 kB。
