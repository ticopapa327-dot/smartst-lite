...
const durationMs = readIntegerEnv("SMARTST_NATIVE_BACKPRESSURE_DURATION_MS", 3000);
const sampleIntervalMs = readIntegerEnv("SMARTST_NATIVE_BACKPRESSURE_SAMPLE_INTERVAL_MS", 500);
const consumeVideoEveryMs = readIntegerEnv("SMARTST_NATIVE_BACKPRESSURE_CONSUME_VIDEO_EVERY_MS", 0);
const consumeAudioEveryMs = readIntegerEnv("SMARTST_NATIVE_BACKPRESSURE_CONSUME_AUDIO_EVERY_MS", 0);
const maxVideoFrames = readIntegerEnv("SMARTST_NATIVE_VIDEO_PAYLOAD_CONSUME_MAX_FRAMES", 2);
const maxAudioPackets = readIntegerEnv("SMARTST_NATIVE_AUDIO_PAYLOAD_CONSUME_MAX_PACKETS", 5);
