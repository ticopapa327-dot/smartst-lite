...
const durationMs = readIntegerEnv("UST_NATIVE_AUDIO_CALL_DRAIN_DURATION_MS", 2000);
const intervalMs = readIntegerEnv("UST_NATIVE_AUDIO_CALL_DRAIN_INTERVAL_MS", 250);
const maxPackets = readIntegerEnv("UST_NATIVE_AUDIO_CALL_DRAIN_MAX_PACKETS", 5);
