...
const durationMs = readIntegerEnv("SMARTST_NATIVE_LOOPBACK_DURATION_MS", 500);
const pollIntervalMs = readIntegerEnv("SMARTST_NATIVE_LOOPBACK_POLL_INTERVAL_MS", 10);
